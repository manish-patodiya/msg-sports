        ...
        <table className="w-full text-left table-auto min-w-max">
          ...
          <tbody>
            <tr>
              ...
              <td className="p-4 border-b border-blue-gray-50">
                <div className="w-max relative grid items-center px-2 py-1 font-sans text-xs font-bold text-green-900 uppercase rounded-md whitespace-nowrap bg-green-500/20">
            ...
            <tr>
              ...
              <td className="p-4 border-b border-blue-gray-50">
                <div className="w-max relative grid items-center px-2 py-1 font-sans text-xs font-bold text-red-900 uppercase rounded-md select-none whitespace-nowrap bg-red-500/20">
